...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCalendar/CapacitorCalendar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorNotificationBadge/CapacitorNotificationBadge.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MauricewegnerCapacitorNavigationBar/MauricewegnerCapacitorNavigationBar.framework"
fi
