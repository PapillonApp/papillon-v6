...
const AlertBottomSheet = ({ visible = true, emphasize = false, title, subtitle, icon, color = '#29975a', cancelAction = () => {}, primaryAction = undefined, cancelButton = 'Compris !', primaryButton = 'Valider'}) => {
