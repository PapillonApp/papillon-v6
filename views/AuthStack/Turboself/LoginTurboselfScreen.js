	...
	return (
		<ScrollView>
			<View style={{height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
				<Image source={require('../../../assets/logo_turboself.png')}
				       style={{height: 100, width: 100, borderRadius: 500, marginBottom: 20}}/>
			...
			{loading ?
				...
				:
				<PapillonButton title="Connexion" color="#B42828" style={{marginHorizontal: 16}} onPress={() => login()}/>
			}
		</ScrollView>
