export const licenceFile = `
<p>Papillon est un logiciel open-source distribué sous licence GPL-v3.0.</p>

<p>En appuyant sur "J'accepte", vous acceptez les termes de la licence GPL-v3.0 et les conditions d'utilisation suivantes :</p>
<ul>
  <li>
  ...
  <li>
    Vos données, aussi bien scolaires que personnelles, ne quittent pas votre appareil, conformément à <a href="https://docs.getpapillon.xyz/documents/privacy-policy/">la politique de confidentialité.</a>  Papillon n'est pas responsable de la sécurité de ces données conservées localement sur votre appareil.
  </li>
  <li>
...
<p>Vous pouvez consulter la licence complète <a href="https://github.com/PapillonApp/Papillon/blob/stable/LICENSE">sur notre dépôt GitHub</a>, ainsi que les conditions générales d'utilisation complètes <a href="https://docs.getpapillon.xyz/documents/terms-of-service/">sur notre documentation</a>.</p>

<p>Si vous n'acceptez pas ces conditions, vous pouvez désinstaller Papillon. Aucune donnée ne sera conservée sur votre appareil.</p>

<p>En cas de problème avec le logiciel ou ses conditions, vous pouvez contacter l'équipe de développement par courriel à l'adresse suivante : <a href="mailto:support@getpapillon.xyz">support@getpapillon.xyz</a>.</p>
`;