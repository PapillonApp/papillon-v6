...
const HeaderSelectScreen = ({ navigation }: { navigation: any }) => {
        ...
        {backgrounds.map((background, index) => (
          <View style={[styles.previewCollection]} key={index}>
            <View style={[styles.previewTitle]}>
              <Text style={[styles.previewH1]}>
                {background.name}
              </Text>
              <Text style={[styles.previewP]}>
                ...
                {background.images.map((image, index) => (
                  ...
                  >
                    <View style={[styles.previewItem, { backgroundColor: selectedColor }]}>
                      ...
                      <View style={[styles.previewItemUIUser, { borderColor: '#ffffff55' }]} />
                      <View style={[styles.previewItemUIPapillon, { backgroundColor: '#ffffff55' }]} />
                      <View style={[styles.previewItemUITitle, { backgroundColor: '#ffffff55' }]} />
                      <LinearGradient
